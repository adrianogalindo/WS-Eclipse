...
public class LocacaoBuilder {
	...
	public static void inicializarDadosPadroes(LocacaoBuilder builder) {
		...
		elemento.setFilmeList(Arrays.asList(FilmeBuilder.umFilme().agora()));
	...
	public LocacaoBuilder comListaFilmeList(Filme... params) {
		elemento.setFilmeList(Arrays.asList(params));
		return this;
	}
