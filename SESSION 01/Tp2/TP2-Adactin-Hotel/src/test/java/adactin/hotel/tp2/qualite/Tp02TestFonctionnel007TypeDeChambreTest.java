...
public class Tp02TestFonctionnel007TypeDeChambreTest
    extends AbstractFunctionalTest {

    public Tp02TestFonctionnel007TypeDeChambreTest() {
    ...
    protected final void validate() {
        ...
        WebElement element = getDriver().findElement(By.xpath("//*[@id=\"room_type_1\"]"));
        String actualValue = element.getAttribute("value");
        Assert.assertTrue("Deluxe".equals(actualValue));

        element = getDriver().findElement(By.xpath("//*[@id=\"room_type_2\"]"));
        actualValue = element.getAttribute("value");
        Assert.assertTrue("Deluxe".equals(actualValue));

        element = getDriver().findElement(By.xpath("//*[@id=\"room_type_3\"]"));
        actualValue = element.getAttribute("value");
        Assert.assertTrue("Deluxe".equals(actualValue));

        element = getDriver().findElement(By.xpath("//*[@id=\"room_type_4\"]"));
        actualValue = element.getAttribute("value");
        Assert.assertTrue("Deluxe".equals(actualValue));
