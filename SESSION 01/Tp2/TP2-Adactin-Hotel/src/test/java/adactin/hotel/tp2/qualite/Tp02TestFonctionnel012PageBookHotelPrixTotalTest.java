...
public class Tp02TestFonctionnel012PageBookHotelPrixTotalTest
    extends AbstractFunctionalTest {
    public Tp02TestFonctionnel012PageBookHotelPrixTotalTest() {
    ...
    protected final void validate() {
        ...
        WebElement element = getDriver().findElement(By.xpath("//*[@id=\"final_price_dis\"]"));
        String actualValue = element.getAttribute("value");
        Assert.assertTrue("AUD $ 4455".equals(actualValue));
