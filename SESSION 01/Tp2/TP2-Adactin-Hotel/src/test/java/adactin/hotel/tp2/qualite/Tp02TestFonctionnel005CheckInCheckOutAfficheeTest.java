...
public class Tp02TestFonctionnel005CheckInCheckOutAfficheeTest
    extends AbstractFunctionalTest {
    public Tp02TestFonctionnel005CheckInCheckOutAfficheeTest() {
    ...
    protected final void validate() {
        ...
        element = getDriver().findElement(By.xpath("//*[@id=\"arr_date_2\"]"));
        actualValue = element.getAttribute("value");
        Assert.assertTrue("01/12/2018".equals(actualValue));
        ...
        element = getDriver().findElement(By.xpath("//*[@id=\"arr_date_3\"]"));
        actualValue = element.getAttribute("value");
        Assert.assertTrue("01/12/2018".equals(actualValue));

        element = getDriver().findElement(By.xpath("//*[@id=\"dep_date_3\"]"));
        actualValue = element.getAttribute("value");
        Assert.assertTrue("10/12/2018".equals(actualValue));

        element = getDriver().findElement(By.xpath("//*[@id=\"arr_date_4\"]"));
        actualValue = element.getAttribute("value");
        Assert.assertTrue("01/12/2018".equals(actualValue));

        element = getDriver().findElement(By.xpath("//*[@id=\"dep_date_4\"]"));
        actualValue = element.getAttribute("value");
        Assert.assertTrue("10/12/2018".equals(actualValue));
    }
