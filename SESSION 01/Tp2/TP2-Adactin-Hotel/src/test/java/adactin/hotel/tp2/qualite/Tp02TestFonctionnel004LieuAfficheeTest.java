...
public class Tp02TestFonctionnel004LieuAfficheeTest
    extends AbstractFunctionalTest {
    public Tp02TestFonctionnel004LieuAfficheeTest() {
    ...
    protected final void validate() {
        ...
        WebElement element = getDriver().findElement(By.xpath("//*[@id=\"location_1\"]"));
        String actualValue = element.getAttribute("value");
        Assert.assertTrue("Sydney".equals(actualValue));

        element = getDriver().findElement(By.xpath("//*[@id=\"location_2\"]"));
        actualValue = element.getAttribute("value");
        Assert.assertTrue("Sydney".equals(actualValue));

        element = getDriver().findElement(By.xpath("//*[@id=\"location_3\"]"));
        actualValue = element.getAttribute("value");
        Assert.assertTrue("Sydney".equals(actualValue));

        element = getDriver().findElement(By.xpath("//*[@id=\"location_4\"]"));
        actualValue = element.getAttribute("value");
        Assert.assertTrue("Sydney".equals(actualValue));
