...
public class Tp02TestFonctionnel006NombreDeChambreAfficheeTest
    extends AbstractFunctionalTest {

    public Tp02TestFonctionnel006NombreDeChambreAfficheeTest() {
    ...
    protected final void validate() {
        ...
        WebElement element = getDriver().findElement(By.xpath("//*[@id=\"rooms_1\"]"));
        String actualValue = element.getAttribute("value");
        Assert.assertTrue("2 Rooms".equals(actualValue));

        element = getDriver().findElement(By.xpath("//*[@id=\"rooms_2\"]"));
        actualValue = element.getAttribute("value");
        Assert.assertTrue("2 Rooms".equals(actualValue));

        element = getDriver().findElement(By.xpath("//*[@id=\"rooms_3\"]"));
        actualValue = element.getAttribute("value");
        Assert.assertTrue("2 Rooms".equals(actualValue));

        element = getDriver().findElement(By.xpath("//*[@id=\"rooms_4\"]"));
        actualValue = element.getAttribute("value");
        Assert.assertTrue("2 Rooms".equals(actualValue));
